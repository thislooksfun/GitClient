...
{
	static func apiCall(var path: String, method: HTTPMethod, headers: [NSObject: AnyObject]?, json: [NSObject: AnyObject]?, errorCallback: ((String?) -> Void)?, callback: (JSON, NSHTTPURLResponse) -> Void)
	{
